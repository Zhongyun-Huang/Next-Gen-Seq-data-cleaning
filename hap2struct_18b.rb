...
he_rpt.puts "Total number of SNPs:                         				#{snps.size}"
he_rpt.puts "Number of herbicide-resistant weeds (HRW):  					#{hrw_num}"																																									#temp
he_rpt.puts "Av. number of hets per HRW individual:  							#{hrw_sum.to_f/hrw_num.to_f}"																																									#temp
he_rpt.puts "Frequency of hets for HRW individuals:  							#{(hrw_sum.to_f/hrw_num.to_f)/snps.size.to_f}"																																									#temp
he_rpt.puts "Number of other individuals:  												#{oth_num}"																																									#temp
he_rpt.puts "Av. number of hets per other individual:  						#{oth_sum.to_f/oth_num.to_f}"																																									#temp
he_rpt.puts "Frequency of hets for other individuals:  						#{(oth_sum.to_f/oth_num.to_f)/snps.size.to_f}"																																									#temp
