...
# == Usage
# 
#   ./hap2struct.rb -i inlist.txt -o for_struct_060512.stru -n 5000
#
...
fail "\nUsage: #$0 -i inlist.txt -o for_struct_060512.stru -n 5000\n" if ARGV.size < 2
...
ind_ids.each do |ind_id|
	...
	stru_handle.puts "#{ind_id}\t1\t#{back_part_string}"
